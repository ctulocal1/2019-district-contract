 ...
 */
declare function sample<Ts>(generator: IProperty<Ts> | Arbitrary<Ts>, params?: Parameters | number): Ts[];
/**
 ...
 * @param params Integer representing the number of values to generate or {@link Parameters} as in {@link assert}
 */
declare function statistics<Ts>(generator: IProperty<Ts> | Arbitrary<Ts>, classify: (v: Ts) => string | string[], params?: Parameters | number): void;
