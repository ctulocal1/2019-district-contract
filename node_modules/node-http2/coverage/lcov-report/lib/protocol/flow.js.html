...
<html lang="en">
<head>
    <title>Code coverage report for lib/protocol/flow.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/protocol/</a> flow.js
    </h1>
    <div class='clearfix'>
...
353
354
355</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">16764×</span>
<span class="cline-any cline-yes">16675×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">17352×</span>
...
<span class="cline-any cline-yes">16453×</span>
<span class="cline-any cline-yes">16453×</span>
<span class="cline-any cline-yes">15769×</span>
<span class="cline-any cline-yes">15769×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">16453×</span>
...
&nbsp;
    assert((!moreNeeded) ||                              // * output queue is full
           ...
           (<span class="branch-2 cbranch-no" title="branch not covered" >!this._window </span>&amp;&amp; (<span class="branch-3 cbranch-no" title="branch not covered" >this._queue[0].type === 'DATA')</span>)); // * waiting for window update
  }
&nbsp;
...
Flow.prototype.read = function read(limit) {
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (limit === -1) {
<span class="cstat-no" title="statement not covered" >    limit = 0;</span>
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if ((limit === undefined) || (limit &gt; MAX_PAYLOAD_SIZE)) {
...
<span class="cstat-no" title="statement not covered" >      return Duplex.prototype.read.call(this, 0);</span>
    }
&nbsp;
...
Flow.prototype._updateWindow = function _updateWindow(frame) {
  this._increaseWindow(frame.flags.END_FLOW_CONTROL ? <span class="branch-0 cbranch-no" title="branch not covered" >Infinity </span>: frame.window_size);
};
&nbsp;
